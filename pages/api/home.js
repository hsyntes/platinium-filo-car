export default function handler(req, res) {
  const meta = {
    ...
    title: "Araç Kiralama | Platinium Filo Car",
  };

  const headings = {
    title: "Araç Kiralamada büyük indirimler Platinum Car Filo'da",
    paragraphs: [
      "Hayalinizdeki arabayı kiralayın. Yenilmez fiyatlar, sınırsız kilometre, esnek teslim alma seçenekleri ve çok daha fazlası.",
